  ...
  return (
    <div>
      ...
      <p>
        ...
        the need of the hour. Many organizations today seek both the flexibility
        to obtain resources when and where needed and the ability to “gear up”
        for projects that require specialized application skills that don’t
        exist or can’t be leveraged internally. Staff augmentation can help you
        achieve a number of business goals including aggressive time-to-market,
        industry and technical experience that accelerates the quality and speed
        of development, and avoiding the cost and time required for internal
        training and skill development. This sudden surge in the demand for
        highly talented manpower calls for the assistance of a specialist.
        MindSoft offers flexibility to your HR function, by providing the
        services of a highly dedicated team, on demand, that can help augment
        top talent in a time efficient manner.
      </p>
      <h4>
      ...
      <div className="my-2">
        ...
        focus and commitment to align with your objectives, add value and evolve
        with the enterprise. With the flexibility in Ramping up and down of
      ...
      <div className="my-2">
        ...
        as our consultants take care of the preliminary selection and screening
        processes, saving you precious time. Also, since the resources are
      ...
      <div className="my-2">
        ...
        that they deliver their best in alignment with your organization's
        objectives. With a high absorption and low drop out rate, MindSoft
        boasts of a staff augmentation solution that is both, cost effective and
        high quality.
      </div>
      <h4>
        <b>We provide following Staff Augmentation Services</b>
      </h4>
      <ul>
...
export default StaffAugmentatuon;
