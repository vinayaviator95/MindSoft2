  ...
  return (
    <div>
      ...
      <div>
        ...
        operations, helps to connect with customers, provides instantaneous
        reports on health and well-being of an organization but also provides
        competitive advantage to organization. Our team of established
        professionals understands the importance of technology in today's
        dynamic business environment. MindSoft offers speciality firms a wide
      ...
      <div>
        ...
        <div>
          ...
          <ul>
            <li>
              Augmentation of project staff in a specific project for short term
              duration.
            </li>
            <li>
              Project execution with end to end project execution responsibility
              of a project with MindSoft team.
            </li>
            <li>
              Managed services with end to end business application
              responsibility with MindSoft team.
            </li>
          </ul>
        </div>
        <h4>
          <b>Technology Services Offered by MindSoft</b>
        </h4>
        <p>
          MindSoft believes that only a well-planned and innovative approach can
          help deliver exceptional results. Therefore, to help you expand the
          scope of your technology planning and management operations, we have
        ...
        <div>
          ...
          this, our business and domain experts bring you objective insight of
          latest trends, timely solutions and well-researched analytics to help
        ...
        <div>
          ...
          this, our highly talented team follows a disciplined approach to
        ...
        <div>
          ...
          development. If you have software solution idea in the form of product
          or application and want to kick start realization without building
          your own technology organization, MindSoft can as your Research and
          Development center.
        </div>
      </div>
    </div>
